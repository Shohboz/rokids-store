...
class ProductAttributesControllerTest < ActionController::TestCase
  ...
  test "should create product_attribute" do
    assert_difference('ProductAttribute.count') do
      post :create, product_attribute: { price: @product_attribute.price, product_id: @product_attribute.product_id, title: @product_attribute.title, value: @product_attribute.value }
    end
  ...
  test "should update product_attribute" do
    patch :update, id: @product_attribute, product_attribute: { price: @product_attribute.price, product_id: @product_attribute.product_id, title: @product_attribute.title, value: @product_attribute.value }
    assert_redirected_to product_attribute_path(assigns(:product_attribute))
  end
